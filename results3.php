			...
			<div class="col-lg-10 col-lg-offset-1 col-md-12">
				...
				<div class="row">
					...
					<div class="col-sm-3 slim">
						<article id="post-<?php the_ID(); ?>" <?php post_class( 'card flip' ); ?> role="article" itemscope itemtype="http://schema.org/BlogPosting" style="background-image: url('<?php the_field('company_logo'); ?>')">
			        <h1><?php the_title(); ?></h1>
							<em><?php the_field('the_figure'); ?></em>
							<?php the_field('performance_metric'); ?> <br class="visible-lg"><?php the_field('time_frame'); ?>
